...
class _$WorkoutImpl implements _Workout {
  ...
  @override
  String toString() {
    return 'Workout(id: $id, courseId: $courseId, name: $name, description: $description, imageUrl: $imageUrl, isComplete: $isComplete, exercises: $exercises)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, courseId, name, description,
      imageUrl, isComplete, const DeepCollectionEquality().hash(_exercises));
